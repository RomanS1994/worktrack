...
export function ProjectsPage() {
  ...
  function closeModal() { if (!isMutating) { setModalOpen(false); setEditingId(''); setForm(EMPTY_FORM); setActionError(''); } }
