...
export function InvoiceDocumentPage({managerMode=false}){
 ...
 const seller=invoice.seller||{};const buyer=invoice.buyer||{};const paymentQr=qrUrl(invoice.paymentDescriptor);
