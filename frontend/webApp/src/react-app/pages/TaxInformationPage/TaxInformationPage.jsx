...
export function TaxInformationPage(){
 ...
 return <section className="taxPage pageStack">
  ...
  <section className="taxCard screenCard"><div className="compactHeader"><h2>{c.invoicing}</h2><p>{c.invoiceCopy}</p></div><button className="taxPrimary" type="button" onClick={()=>navigate('/invoices')}>{c.openInvoices}</button></section>
