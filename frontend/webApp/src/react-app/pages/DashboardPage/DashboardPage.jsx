...
import { formatCzk, resolveLocale } from '../../app/formatters.js';
...
function formatDashboardHours(value,language,locale){
  const hours=Number(value||0);
  const formatted=new Intl.NumberFormat(locale,{minimumFractionDigits:0,maximumFractionDigits:2}).format(Number.isFinite(hours)?hours:0);
  return `${formatted} ${language==='uk'?'год':'h'}`;
}
