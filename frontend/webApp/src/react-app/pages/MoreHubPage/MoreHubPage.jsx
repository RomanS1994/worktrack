...
export function MoreHubPage(){
 ...
 return <section className="moreHub pageStack">
  ...
  <SettingsGroup title={c.accountGroup}><SettingsRow to="/profile?section=language&from=settings" icon="globe" tone="language" title={c.language} copy={c.languageCopy}/></SettingsGroup>
  <SettingsGroup title={c.securityGroup}><SettingsRow to="/profile?section=password&from=settings" icon="lock" tone="security" title={c.security} copy={c.securityCopy}/><SettingsRow to="/profile?section=account&from=settings" icon="trash" tone="danger" title={c.accountManagement} copy={c.accountManagementCopy}/></SettingsGroup>
