...
const COPY = {
  uk: { title:'Налаштування',copy:'Керуйте параметрами компанії та акаунта.',changePhoto:'Змінити фото',photoError:'Не вдалося змінити фото.',photoTooLarge:'Фото має бути до 5 МБ.',companyGroup:'Компанія',identity:'Дані компанії',identityCopy:'Назва, адреса та системні дані',billing:'Реквізити',billingCopy:'IČO, DIČ, адреса та email для рахунків',workGroup:'Робочі правила',work:'Робочий час',workCopy:'Обід, денна норма та графік роботи',accountGroup:'Особисті налаштування',personal:'Особисті дані',personalCopy:'Імʼя, телефон та фото профілю',language:'Мова',languageCopy:'Мова інтерфейсу застосунку',securityGroup:'Безпека й акаунт',security:'Змінити пароль',securityCopy:'Оновіть пароль для входу в акаунт',accountManagement:'Керування акаунтом',accountManagementCopy:'Видалення акаунта',signOut:'Вийти з акаунта',signingOut:'Вихід…' },
...
export function MoreHubPage(){
 ...
 return <section className="moreHub pageStack">
  ...
  <SettingsGroup title={c.accountGroup}><SettingsRow to="/profile?section=personal&from=settings" icon="user" tone="personal" title={c.personal} copy={c.personalCopy}/><SettingsRow to="/profile?section=language&from=settings" icon="globe" tone="language" title={c.language} copy={c.languageCopy}/></SettingsGroup>
