...
const COPY={
 ...
 cs:{title:'Výdaje',subtitle:'Firemní výdaje za zvolené období',month:'Měsíc',category:'Kategorie',all:'Všechny kategorie',total:'Výdaje za měsíc',count:'Počet výdajů',history:'Historie výdajů',empty:'V tomto měsíci nejsou žádné výdaje',add:'Přidat výdaj',delete:'Smazat',confirm:'Smazat tento výdaj?',employee:'Zaměstnanec',receipt:'Doklad',openingReceipt:'Otevírání…',receiptError:'Fotografii dokladu se nepodařilo otevřít.',details:'Detail výdaje',date:'Datum',note:'Poznámka',noNote:'Bez poznámky',viewReceipt:'Zobrazit fotografii',addReceipt:'Přidat fotografii dokladu',replaceReceipt:'Změnit fotografii',preparingReceipt:'Příprava fotografie…',savingReceipt:'Ukládání…',receiptInvalid:'Vyberte JPG, PNG nebo WebP.',receiptTooLarge:'Fotografie je příliš velká.',receiptSaveError:'Fotografii dokladu se nepodařilo uložit.',close:'Zavřít'},
