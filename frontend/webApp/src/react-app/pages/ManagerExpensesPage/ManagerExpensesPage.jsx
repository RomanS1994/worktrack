...
const COPY={
 uk:{title:'Витрати',subtitle:'Витрати компанії за вибраний період',month:'Місяць',category:'Категорія',all:'Усі категорії',total:'Витрачено за місяць',count:'Кількість витрат',history:'Історія витрат',empty:'За цей місяць витрат немає',add:'Додати витрату',delete:'Видалити',confirm:'Видалити цю витрату?'},
 cs:{title:'Výdaje',subtitle:'Firemní výdaje za zvolené období',month:'Měsíc',category:'Kategorie',all:'Všechny kategorie',total:'Výdaje za měsíc',count:'Počet výdajů',history:'Historie výdajů',empty:'V tomto měsíci nejsou žádné výdaje',add:'Přidat výdaj',delete:'Smazat',confirm:'Smazat tento výdaj?'},
 en:{title:'Expenses',subtitle:'Company expenses for the selected period',month:'Month',category:'Category',all:'All categories',total:'Spent this month',count:'Number of expenses',history:'Expense history',empty:'No expenses this month',add:'Add expense',delete:'Delete',confirm:'Delete this expense?'}
};
