...
const ERROR_COPY = {
  uk: {
    ...
    'Invalid plan': 'Вибрано некоректний тарифний план.',
    'Name is required': 'Вкажіть ім’я.', 'Email is required': 'Вкажіть e-mail.',
  ...
  cs: {
    ...
    'Invalid plan': 'Byl zvolen neplatný tarif.', 'Name is required': 'Zadejte jméno.', 'Email is required': 'Zadejte e-mail.',
