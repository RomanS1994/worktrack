export const pageMessages = {
  uk: {
    fastHours: {
      eyebrow: 'Робочий час', title: 'Мої години', thisWeek: 'Цей тиждень', previous: 'Назад', next: 'Далі', project: 'Об’єкт', quick: 'Швидке заповнення', weekday: '8 год Пн–Пт', clear: 'Очистити', hours: 'Години', total: 'Разом', save: 'Зберегти тиждень', saving: 'Збереження…', send: 'Відправити менеджеру', advanced: 'Детальний режим', advancedCopy: 'Кілька об’єктів в один день або редагування окремих записів', saved: 'Тиждень збережено', noProjects: 'Немає активних об’єктів', draft: 'Чернетка', submitted: 'Відправлено', approved: 'Погоджено', rejected: 'Повернено', locked: 'Цей тиждень уже відправлено та заблоковано для редагування.'
    },
    hoursTable: {
